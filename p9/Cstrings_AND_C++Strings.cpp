...
int main(){
    ...
    std::string s6(3,'x')//Constructor syntax creates a string with 3 Xs
    std::string s7{"C++"};
    ...
    // at which the phrase begins at, if for some reason is is unable to find the string
    // it will return the string::npos
